...
public class MancalaGameFinal extends JFrame {
        ...
        timer.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (remainingStones[0] == 0) {
                    ...
                    if (board[last] > 1 && ((playerOneTurn && last >= 0 && last <= 5) || (!playerOneTurn && last >= 7 && last <= 12))) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(MancalaGameFinal::new);
    }
}
